...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA_EMS /ems/elsc-labs/segev-i/yoni.leibner/PycharmProjects/Hippocampus_Basu/mods_2/ProbAMPANMDA_EMS.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ems/elsc-labs/segev-i/yoni.leibner/PycharmProjects/Hippocampus_Basu/mods_2/ProbAMPANMDA_EMS.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "/**\n"
