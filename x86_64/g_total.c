...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 59, "pointer");
 	...
 	ivoc_help("help ?1 g_total /ems/elsc-labs/segev-i/yoni.leibner/PycharmProjects/Hippocampus_Basu/mods_2/g_total.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ems/elsc-labs/segev-i/yoni.leibner/PycharmProjects/Hippocampus_Basu/mods_2/g_total.mod";
static const char* nmodl_file_text = 
