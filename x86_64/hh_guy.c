...
#define nrn_init _nrn_init__hh_guy
#define _nrn_initial _nrn_initial__hh_guy
#define nrn_cur _nrn_cur__hh_guy
#define _nrn_current _nrn_current__hh_guy
#define nrn_jacob _nrn_jacob__hh_guy
#define nrn_state _nrn_state__hh_guy
#define _net_receive _net_receive__hh_guy 
#define _f_rates _f_rates__hh_guy 
#define rates rates__hh_guy 
#define states states__hh_guy 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hh_guy", _hoc_setdata,
 "rates_hh_guy", _hoc_rates,
 "vtrap_hh_guy", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_hh_guy
...
#define _gth 0
#define htau_hh_guy _thread1data[0]
#define htau _thread[_gth]._pval[0]
#define hinf_hh_guy _thread1data[1]
#define hinf _thread[_gth]._pval[1]
#define mtau_hh_guy _thread1data[2]
#define mtau _thread[_gth]._pval[2]
#define minf_hh_guy _thread1data[3]
#define minf _thread[_gth]._pval[3]
#define ntau_hh_guy _thread1data[4]
#define ntau _thread[_gth]._pval[4]
#define ninf_hh_guy _thread1data[5]
#define ninf _thread[_gth]._pval[5]
#define usetable usetable_hh_guy
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_hh_guy", 0, 1e+09,
 "gkbar_hh_guy", 0, 1e+09,
 "gnabar_hh_guy", 0, 1e+09,
 "usetable_hh_guy", 0, 1,
 0,0,0
};
 ...
 "minf_hh_guy", &minf_hh_guy,
 "hinf_hh_guy", &hinf_hh_guy,
 "ninf_hh_guy", &ninf_hh_guy,
 "mtau_hh_guy", &mtau_hh_guy,
 "htau_hh_guy", &htau_hh_guy,
 "ntau_hh_guy", &ntau_hh_guy,
 "usetable_hh_guy", &usetable_hh_guy,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 hh_guy /ems/elsc-labs/segev-i/yoni.leibner/PycharmProjects/Hippocampus_Basu/mods_2/hh_guy.mod\n");
...
static int _reset;
static char *modelname = "hh_guy.mod   squid sodium, potassium, and leak channels";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/ems/elsc-labs/segev-i/yoni.leibner/PycharmProjects/Hippocampus_Basu/mods_2/hh_guy.mod";
static const char* nmodl_file_text = 
  "TITLE hh_guy.mod   squid sodium, potassium, and leak channels\n"
  " \n"
  "COMMENT\n"
  ...
  "\n"
  "  Yoni: we changed the parameters to fit guy eyal work in https://www.jneurosci.org/content/34/24/8063\n"
  "ENDCOMMENT\n"
  " \n"
  "UNITS {\n"
  "        (mA) = (milliamp)\n"
